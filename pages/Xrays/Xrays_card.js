...
export default function Xrays_card() {
    ...
    const getCenterCard = async () => {
        try {
            const response = await axios.get(`https://sehtak.herokuapp.com/x_rays/profile/${id}`);
    ...
    return (
        <>
            ...
            <div className='main'>
                <div>
                    <h1 className={styles.titleb}>X-Ray Card</h1>
                    <Image src='/images/xr_prof.png' alt='' height='230' width='230' />
                </div>
                <div>
